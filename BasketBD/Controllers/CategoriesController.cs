...
namespace BasketBD.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(BasketBDContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var category = await _context.Category
                .SingleOrDefaultAsync(m => m.CategoryName == id);
            if (category == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryName,SubCategory,Description,SerialNo")] Category category)
        {
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var category = await _context.Category.SingleOrDefaultAsync(m => m.CategoryName == id);
            if (category == null)
            {
                return NotFound();
            }
